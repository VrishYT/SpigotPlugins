...
public class Inventories implements Listener {
	...
	public void createKit(Player player) {
		...
		ArrayList<String> lcan = (new ArrayList<String>());
		ArrayList<String> lcon = (new ArrayList<String>());
		...
		bottom.setItemMeta(mbot);
		cancel.setItemMeta(mcan);
		confirm.setItemMeta(mcon);
